...
public class DataLoader implements CommandLineRunner {
	...
	private record AuthorsAndBooks(Map<String, Author> authors, Map<String, Book> books) {
	}
	...
	private AuthorsAndBooks loadAuthorsAndBooks() {
		...
		return new AuthorsAndBooks(
				Map.of("josh", josh, "mark", mark, "greg", greg, "dan", dan, "nate", nate, "craig", craig),
				Map.of("cloudNative", cloudNative, "reactiveSpring", reactiveSpring, "springBootInAction",
						springBootInAction, "learningSpring", learningSpring, "fundamentals", fundamentals,
						"springInAction", springInAction, "springAiInAction", springAiInAction));
	}
}